...
let changeResult = function (result) {
    document.querySelector(".result").textContent = result;
};

let changeHead = function (heading) {
            ...
            if (!value) {
                ...
                if (value != luckyNum) {
                    if (score > 1) {
                        ...
                        //     value < luckyNum ? "Too Low..." : "Too High...";
                        changeResult(
                            value < luckyNum ? "Too Low..." : "Too High...",
                        );
                        score--;
